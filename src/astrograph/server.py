...
def create_server() -> Server:
    ...
    server = Server(
        ...
        instructions=(
            ...
            "When running inside Docker (the typical MCP deployment), the host workspace is "
            "mounted at /workspace — always use /workspace (not host absolute paths) for "
            "set_workspace and file operations. "
