...
class EntryStore:
    ...
    def _get_meta_attr(self, eid: str, attr: str) -> object:
    ...
    def get_node_count(self, eid: str) -> int | None:
        ...
        return cast("int | None", self._get_meta_attr(eid, "node_count"))

    def get_hierarchy_hashes(self, eid: str) -> list[str] | None:
        """Get hierarchy_hashes from hot metadata without loading the full entry."""
        return cast("list[str] | None", self._get_meta_attr(eid, "hierarchy_hashes"))
